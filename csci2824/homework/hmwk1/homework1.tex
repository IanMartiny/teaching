...
%% Question 1
  ...
  \begin{parts}
    ...
    \part $x+4 > 10$
    \begin{solution}
      No, this is a predicate. On its own this does not have a truth value, only
      when something is plugged in for $x$.
    \end{solution}
 ...
 %% Question 3
  ...
  \begin{parts}
    ...
    \begin{solution}
      ...
      By the above paragraphs the two statements are logically equivalent,
